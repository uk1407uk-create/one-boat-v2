...
function aiMetrics(rows){
  const out={
    ...
    box:{name:'BOX型',range_label:'3艇BOX×2組・12点',strategy:true,races:0,hits:0,stake_yen:0,payout_yen:0,hit_odds_total:0}
  };
  for(const r of rows){
